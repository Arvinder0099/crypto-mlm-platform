    ...
    <Box sx={{ width: '100%', p: 3 }}>
      ...
      <Paper sx={{ width: '100%' }}>
        ...
        >
          ...
          {/* <Tab label="KYC Management" icon={<Fingerprint />} /> */}
        ...
        <TabPanel value={activeTab} index={0}>
          <Alert severity="success" sx={{ mb: 3 }}>
            Security settings are properly configured and operational.
          </Alert>
...
export default SecurityComplianceFixed;